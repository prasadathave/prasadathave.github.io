...
var data = {
    ...
    "Ba" :{
        ...
        "8": {
            ...
            "Skills Required ": "\nhttps://drive.google.com/file/d/1R5fOcE7P5E0wnWxYuRVGRjmQbNtfH_my/view?usp=sharing",
        ...
        "22": {
            "Sr.No.": "22",
            "Company Name": "ITC",
            "Project Details ": "1. Development of low cost drip irrigation system for sustaining small farmers\u2019 profitability.\n",
...
$(document).ready(function () {
    ...
    $(".A").click(function(){
        ...
        $(".container h2").text("Institute Building Projects");
        $(".container h4").text(heads[ele]);
        generateHtmlTable(displaydata);
    });
    $(".B").click(function(){
        $("#csv-display").empty();
        var ele = $(this).attr('id');
        console.log(ele)
        displaydata = data[ele];
        $(".container h2").text("Industrial Projects");
        $(".container h4").text(heads[ele]);
        generateHtmlTable(displaydata);
    });
});
